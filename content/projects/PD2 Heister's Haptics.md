...
This works although I had some issues with start, since start apparently take the [first argument starting with quotes to set the window title](https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/start).
